...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/lib/jquery/jquery-1.12.4.min.js"></script>
<script type="text/javascript"
		...
		<form action="user/login.action" method="post">
			...
			<div id="bottom">
				<div id="inner">
					...
					<div class="img-login">
						<img src="${pageContext.request.contextPath }/img/qq.png"
							width="25" height="25">
					</div>
					<div>
...
<script type="text/javascript">
	function regist() {
		...
		var baseLink = document.getElementsByTagName("base")[0]
				.getAttribute("href");
		window.location.href = baseLink + "user/regist.action";
		 */
		return false;
	}
</script>
